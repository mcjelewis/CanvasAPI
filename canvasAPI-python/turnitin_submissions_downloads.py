...
#domain = "ewu.test.instructure.com"
#domain = "ewu.beta.instructure.com"
#domain = "ewu.instructure.com"
csvFileName = "Canvas-turnitin_submissions"
folderPath1 = "/Applications/MAMP/htdocs/Canvas-python/turnitin/submissions/"
hasData = False
##################################################
...
domain = input('Domain Name (ewu.test.instructure.com):')
if not domain:
    print('#########################################################################')
...
courseFilter = input('Do you want to filter data to selected courses, If yes, enter the Course ID(s) [if multiple courses, seperate with a comma: 1234, 5678, 9012]:')
if courseFilter:
